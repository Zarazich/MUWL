...
class User(SqlAlchemyBase):
    ...
    sent_messages = orm.relationship('Message', foreign_keys='Message.sender_id', backref='sender')
    received_messages = orm.relationship('Message', foreign_keys='Message.recipient_id', backref='recipient')