...
def encrypt_message(message_key: str, route_key: str, chat_id: str, message: str) -> str:
    ...
    packet = struct.pack(f'!I{route_len}s{len(encrypted_message)}s',
                         route_len, encrypted_route, encrypted_message)
    return base64.b64encode(packet).decode('utf-8')


def validate_route(route_key: str, expected_chat_id: str, encrypted_packet_b64: str) -> bool:
    try:
